...
export default async function HistoryPage({
  ...
  if (sheetId) {
    ...
    const morningScanned = new Set(
      selected.filter(r => r.status !== 'กลับบ้าน').map(r => r.student_id)
    )
  ...
  return (
    <>
      ...
      <FilterBar grades={grades} rooms={rooms} selGrade={selGrade} selRoom={selRoom} selDate={selDate} basePath="/teacher/history" showDate={true} showGradeRoom={false} />
